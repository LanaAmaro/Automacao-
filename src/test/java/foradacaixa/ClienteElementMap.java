...
public class ClienteElementMap {
	...
	// endereço cobrança
	protected WebElement endpc_cep;
	protected WebElement endpc_endereco;
	protected WebElement endpc_numero;
	protected WebElement endpc_complemento;
	protected WebElement endpc_cidade;
